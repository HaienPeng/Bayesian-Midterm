...
在贝叶斯Group LASSO中,层次模型可以表示为:$$

y \sim N(X\beta,\sigma^2I)\\
\beta_g|\tau_g^2,\sigma^2\sim N(0,\sigma^2\tau_g^2I)\\
\tau_g^2 \sim Gamma(a,b)

$$通过对组别方差参数 $\tau_g^2$ 施加 Gamma 先验，Bayesian Group LASSO 能在贝叶斯框架下实现对整组系数的自适应收缩，从而达到与 Group LASSO 相同的组稀疏效果，同时提供参数不确定性的估计。
